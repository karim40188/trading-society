...
import backgroundImage from "../../assets/BluredImgHome.png"; // Adjust the path
				...
				>
					...
					>
						...
						>
							...
							>
								Take the power of Trading Society with you
								wherever you go. Download our mobile app to
								access tools that help you make smarter trading
								decisions and track your progress in real time,
					...
					<Box
						sx={{
							...
							backgroundSize: "100% 130%", // Covers left half
							position: "absolute",
							backgroundPosition: "right center", // Make sure image is positioned correctly
							left: "70vh",
							bottom: "0px",
					...
					>
						<Box
							sx={{
								...
								width: { xs: "300px", lg: "550px" },
								height: { xs: "300px", lg: "550px" },
								backgroundRepeat: "no-repeat",
