			...
			<Box sx={{}}>
				...
				>
					...
					>
						...
						<Typography
							...
							sx={{
								fontSize: {
									...
									md: "40px",
									xl: "45px",
								}, // حجم النص المناسب للشاشات الصغيرة
								color: "#ECBC56",
								marginY: "10px",
							}}
						>
						...
						>
							Stay Ahead of the Market with <br /> Daily Trade
							Ideas from Trading Society Traders !
						</Typography>
						<Typography
							sx={{
						...
						>
							Unlock profitable opportunities by following our
							traders trade alerts, delivered daily for Forex,
