...
import backgroundImage from "../../assets/footerBG.png"; // Adjust the path
...
function Footer() {
  ...
  return (
    ...
    sx={{
      ...
      color: "#fff",
      mt: "12px",
      // backgroundImage: `url(${backgroundImage}), linear-gradient(rgba(224, 217, 217, 0.05), rgba(0, 0, 0, 0.9))`, // Adding the black filter overlay
        ...
        >
          ...
          />
            ...
            <Box
              sx={{
                color: "gray",
                fontSize: { xs: "14px", md: "1px", xl: "20px" },
                textAlign: { xs: "center", md: "left" },
                mb: { xs: 4, md: 0 },
                width: { xs: "100%", md: "20%" },
              }}
            >
              <Typography sx={{ fontSize: { xs: "16px", md: "20px", xl: "15px" },lineHeight:"20px",fontFamily:"poppins" }}>Empowering traders with real-time tools,expert education, and a strong community.</Typography>
        ...
        <Grid2 
          ...
          <Grid2 size={{ xs: 12, md: 4, lg: 2 }} >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <Box sx={{ width: "25px", height: "25px" }}>
                <FaEnvelope
                  style={{ color: "#ECBC56", width: "30px", height: "100%" }}
                />
              </Box>
