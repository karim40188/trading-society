...
// components
import TradingViewWidget from "./CurrencyPair";
import { Box, Typography } from "@mui/material";
import { FaRegCopy } from "react-icons/fa6";
import { IoCheckmarkDoneOutline } from "react-icons/io5";
import { TbChartCandle } from "react-icons/tb";
import   ForexRiskCalculator from "./ForexCalc"; 
// assets
    ...
    >
      {offers.map((offer, index) => (
        ...
        >
          ...
          <Box 
            sx={{ display: "flex", justifyContent: "space-between",width:"400px",height:"1000px"}}>
            <TradingViewWidget symbol={`OANDA:${offer.pair}`} width={400} colorTheme="dark" />
            <ForexRiskCalculator/>
          </Box>
          <Box sx={{ mx: "auto" }}>
            <Box
